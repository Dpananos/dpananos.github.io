...
sim_decisions_M <- function(n = 5000,
                             prior_mean = 0,
                             prior_sd = 0.05,
                             control_mean = 2.0,
                             prob_treatment = 0.5,
  ...
  # --- 4. Decision Rule ---
  # Ship if posterior mean M > 0
  impact <- ifelse(M > 0, true_lift, 0)

  mean(impact)
}

analytic_decisions_M <- function(n = 5000,
                                  prior_mean = 0,
                                  prior_sd = 0.05,
                                  control_mean = 2.0,
                                  prob_treatment = 0.5) {
  ...
  # --- 2. Critical Hurdle ---
  # M > 0 iff hat_lambda > -prior_mean * se_lift^2 / prior_sd^2
  # With prior_mean = 0, lambda_crit = 0
