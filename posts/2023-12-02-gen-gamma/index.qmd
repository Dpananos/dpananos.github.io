...
and $T = \log(Y)$ is distributed according to the generalized gamma distribution .  Here, $-\infty \lt z \lt \infty$, $-\infty \lt \mu \lt \infty$,  and $\sigma, k>0$.  For more on the generalized gamma, especially for use in survival analysis, see *Statistical Models and Methods for Lifetime Data* by Jerry Lawless (1982).
