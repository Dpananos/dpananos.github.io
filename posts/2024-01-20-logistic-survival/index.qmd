...
Here, $d_i$ are those who experience the number of subjects who experience the outcome at time $t_i$ and $n_i$ is the number of individuals known to have survived up to time $t_i$.  In essence, the product limit estimator is a product of a sequence of probabilities.  What else do we use to model probabilities?  Logistic regression.
