...
## 1.  The Coefficients of Logistic Regression are Interpreted as "You're X Times More Likely to See Y Given Factor Z".  
...
axins = ax.inset_axes(
    ...
    xlim=(1, 1.5), ylim=(1, 1.5), xticklabels=[], yticklabels=[])
