...
In brief, I agree with SPE and we've all heard before.  Data science is suffering from being a bullshit job, but clearly quantitative thinking is useful in business.  What should be taught if not XGBoost API's and linear algebra theory?
...
That feels reductive. Those can't be the only two measures of a good data scientist (if such a thing exists). I can only speak to my (limited) experience in tech, but many of the problems facing data scientists are not purely tech or math problems, so it doesn't make sense to value data scientists on their ability to solve just those kinds of problems.  The majority of problems data scientists face are people problems.
